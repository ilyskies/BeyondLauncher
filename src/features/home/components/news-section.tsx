...
import { NewsItem } from "@/shared/types/socket";

const defaultNewsItems: NewsItem[] = [
  {
    id: "default",
    title: "BEYOND",
    subtitle: "Welcome to Beyond",
    description: "Experience Chapter 2 - Season 5 with Beyond!",
    backgroundImage:
...
export function NewsSection() {
  ...
  if (!currentNews) {
    return (
      <section className="news-section relative">
        <div className="bg-[rgba(15,23,42,0.4)] backdrop-blur-[28px] backdrop-saturate-[160%] border border-[rgba(59,130,246,0.2)] overflow-hidden rounded-xl h-96 flex items-center justify-center">
  ...
  return (
    <section className="news-section relative">
      <div
        className={`bg-[rgba(15,23,42,0.4)] backdrop-blur-[28px] backdrop-saturate-[160%] border border-[rgba(59,130,246,0.2)] overflow-hidden group 
        transition-all duration-500 shadow-[0_6px_24px_rgba(0,0,0,0.25),0_0_0_1px_rgba(59,130,246,0.08)_inset] hover:shadow-[0_8px_32px_rgba(0,0,0,0.35),0_0_0_1px_rgba(59,130,246,0.12)_inset]
        relative rounded-xl hover:border-[rgba(59,130,246,0.4)]`}
